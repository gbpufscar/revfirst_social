...
def handle(context: "CommandContext") -> ControlResponse:
    ...
    lines = [
        ...
        "/queue",
        "/preview <queue_id>",
        "/approve <queue_id> (aprova e agenda na proxima janela UTC)",
        "/approve_now <queue_id> [override] (publica imediatamente)",
        "sim | aprovado (equivalente a /approve_now no item pendente mais recente)",
        "/reject <queue_id>",
        "/pause [global]",
        "/resume [global]",
