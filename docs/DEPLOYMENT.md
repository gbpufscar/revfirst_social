...
- `MAX_REPLIES_PER_HOUR=8` (0 disables hourly reply quota)
- `MAX_CONSECUTIVE_PUBLISH_FAILURES=3` (0 disables circuit breaker)
- `DAILY_PUBLISH_WINDOWS_UTC=07:30,16:30,20:30`
- `POSTS_PER_DAY_TARGET=3`
- `MAX_REGEN_PER_DAY=3`
